...
func NewConverter(fromCurrency, toCurrency *Currency) (*Converter, error) {
	if fromCurrency == nil {
		return nil, ErrFromCurrencyIsNil
	}
	if toCurrency == nil {
		return nil, ErrToCurrencyIsNil
	}
	...
	if errUpdate := converter.ForceUpdate(); errUpdate != nil {
...
func Convert(fromCurrency, toCurrency *Currency, amount float64) float64 {
	if fromCurrency == nil {
		panic(ErrFromCurrencyIsNil)
	}
	if toCurrency == nil {
		panic(ErrToCurrencyIsNil)
	}
